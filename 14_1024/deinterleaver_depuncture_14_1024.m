function L_D_a=deinterleaver_depuncture_14_1024(L_M_e,QAMInterleaver,turboL)
%Give out the L_D_a
%QAM depuncture and deinterleaver
tempL=[];
for i=1:14:length(L_M_e)
    tempFourteen=L_M_e(1,i:(i+13));
    %Add zeros
    pp=zeros(1,length(QAMInterleaver)-14);
    tempT21=[tempFourteen,pp];
    %QAM deinterleaver
