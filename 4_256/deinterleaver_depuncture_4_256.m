function L_D_a=deinterleaver_depuncture_4_256(L_M_e,QAMInterleaver,turboL)
%Give out the L_D_a
%QAM depuncture and deinterleaver
tempL=[];
for i=1:8:length(L_M_e)
    tempEight=L_M_e(1,i:(i+7));
    %Add zeros
    pp=zeros(1,length(QAMInterleaver)-8);
    tempT21=[tempEight,pp];
    %QAM deinterleaver
