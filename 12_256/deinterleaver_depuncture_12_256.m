function L_D_a=deinterleaver_depuncture_12_256(L_M_e,QAMInterleaver,turboL)
%Give out the L_D_a
%QAM depuncture and deinterleaver
tempL=[];
for i=1:12:length(L_M_e)
    tempTwelve=L_M_e(1,i:(i+11));
    %Add zeros
    pp=zeros(1,length(QAMInterleaver)-12);
    tempT21=[tempTwelve,pp];
    %QAM deinterleaver
